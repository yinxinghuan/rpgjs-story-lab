...
import {oldStreetPhotoWallRegions} from '../src/old-street-photo-environment-layout'
...
test('photo wall decorations leave authoritative floor and north doorway clear',()=>{
 const floor=oldStreetFloors.photo,door=oldStreetDoors().find(d=>d.room==='photo'&&d.side==='N')!
 const regions=oldStreetPhotoWallRegions()
 const png=PNG.sync.read(readFileSync('doc/oldstreet-photo-wall/candidate.png'))
