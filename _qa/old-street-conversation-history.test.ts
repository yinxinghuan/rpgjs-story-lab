...
test('history restores paired turns, excludes current exchange, deduplicates and limits to four',()=>{
 ...
 assert.deepEqual(oldStreetConversationHistory(restored,'zhou-watchmaker',current).map(r=>r.id),['turn-1','turn-2','turn-3','turn-4'])
