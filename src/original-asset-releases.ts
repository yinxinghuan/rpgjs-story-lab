...
const currentFixedEquipment=():FixedEquipmentBindings=>({'tunnel-fan':'tunnel-fan-parts-v1','brakes':'brake-parts-v1','river-fuel-locker':'river-diesel-v1','pine-reserve':'pine-diesel-v1','tunnel-reserve':'tunnel-diesel-v1','pass-reserve':'pass-diesel-v1','bridge-reserve':'bridge-diesel-v1'})
