...
export type OriginalAssetBindings={version:1;backgrounds:Record<string,string>}|{version:2;published:PublishedBackground}
...
export function originalBackgroundVersion(bindings?:OriginalAssetBindings){assertOriginalAssetBindings(bindings);return bindings?.version===2?bindings.published.id:bindings?.backgrounds[northCape]??ORIGINAL_BACKGROUND_BASELINE}
