...
export function oldStreetContextAction(save:StorySave,entity:Entity){
 ...
 const priority=(id:string)=>id.startsWith('oldstreet:greet-')?0:['oldstreet:return-clock','oldstreet:return-photos','oldstreet:return-trolley'].includes(id)?1:id==='oldstreet:return-key'?(save.facts['letter-unlocked']?1:5):2
