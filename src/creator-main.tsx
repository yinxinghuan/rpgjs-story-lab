...
root.render(query.get('create_art')==='layers'?<LayeredCreator/>:query.get('create_art')==='sprite'?<SpriteCreator/>:query.get('scene_preview')==='north-cape'?<OriginalScenePreview/>:<ArtCreator/>)
