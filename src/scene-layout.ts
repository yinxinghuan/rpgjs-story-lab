...
export type SceneId='carriage'|'baggage'|'cab'
...
export const sceneIds:SceneId[]=['carriage','baggage','cab']
...
export const approachPoints={'zhou-yu':{x:190,y:260},cabinet:{x:158,y:132},panel:{x:220,y:132},lin:{x:188,y:184},exit:{x:188,y:80},supply:{x:158,y:160},record:{x:192,y:216},forward:{x:188,y:80},back:{x:188,y:472},radio:{x:188,y:248},cabBack:{x:188,y:472}} as const
...
export const portalArrivals:Record<string,{scene:SceneId;position:Point}>={leave:{scene:'baggage',position:{x:188,y:464}},'go-baggage':{scene:'baggage',position:{x:188,y:464}},'back-carriage':{scene:'carriage',position:{x:188,y:88}},'enter-cab':{scene:'cab',position:{x:188,y:464}},'back-baggage':{scene:'baggage',position:{x:188,y:88}}}
