...
export default function OriginalIllustrationPanel({head,api}:{head:OriginalHead;api:Transport}){
 ...
 const endpoint='/sessions/'+head.id+'/illustrations',job=jobs.find(j=>j.scene===selected),key=selected+':'+(job?.asset?.sha256??'')
