...
export function oldStreetPhotoMatches(value:unknown,version:string=oldStreetPhotoPuzzle.version):boolean{
 const v=value as {version?:unknown;piece?:unknown;rotation?:unknown}
 return !!v&&v.version===version&&v.piece==='piece-river'&&v.rotation===0
}
