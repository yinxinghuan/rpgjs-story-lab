...
export default function OldStreetLoading({locale,stage='page',done=0,total=0,failed=false,failureMessage,onRetry}:{locale:'zh'|'en';stage?:string;done?:number;total?:number;failed?:boolean;failureMessage?:string;onRetry?:()=>void}){
