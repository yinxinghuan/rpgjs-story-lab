import {verifySpritePng,type SpriteDraft,type SpriteDraftRepository} from './sprite-draft'
...
function binding(d:SpriteDraft){
...
export function assertActorSheetReview(r:any,d:SpriteDraft):asserts r is ActorSheetReview{
