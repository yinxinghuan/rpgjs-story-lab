...
export type OldStreetExpansionRequest={
 ...
 input:string;status:'requested';requestedAtVersion:number;archiveSource?:ArchivePhotoSource;photoMethod?:'develop-v1'
}
export function assertOldStreetExpansions(value:unknown):asserts value is OldStreetExpansionRequest[]|undefined{
 ...
 for(const r of value){
  if(r?.photoMethod!==undefined&&r.photoMethod!=='develop-v1')throw Error('INVALID_EXPANSIONS')
