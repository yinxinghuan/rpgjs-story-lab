...
export function assertProtagonistIdentity(value: unknown, sourceSha256: string): asserts value is ProtagonistIdentity {
  ...
  if (!v || Object.keys(v).sort().join(',') !== 'referenceSha256,slot,sourceSha256,version'
    || v.version !== 1 || v.slot !== 'protagonist'
...
export function protagonistIdentity(referenceSha256: string, sourceSha256: string): ProtagonistIdentity {
  const value: ProtagonistIdentity = {version: 1, slot: 'protagonist', referenceSha256, sourceSha256}
