...
export const explorationCircuitAdmission={ready:false,missing:['approved room artwork','item discovery rules','complete story cartridge and session version routing']} as const
