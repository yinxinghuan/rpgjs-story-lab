...
export function OldStreetExpansionView({locale,sessionId,requested,disabled,api,submit,activate,archiveTitle}:{locale:'zh'|'en';sessionId:string;requested:boolean;disabled:boolean;api:(path:string,body?:unknown)=>Promise<any>;submit:(text:string,followArchive?:boolean)=>Promise<void>;archiveTitle?:string;activate:()=>Promise<void>}){
