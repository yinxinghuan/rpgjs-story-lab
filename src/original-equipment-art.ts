...
import {originalStarterRelease,originalFixedEquipment,type OriginalAssetBindings} from './original-asset-releases'
...
export function originalEquipmentHasArt(id:string,assets?:OriginalAssetBindings){return id==='starter'||id==='tunnel-fan'&&Boolean(originalFixedEquipment(assets)['tunnel-fan'])}
