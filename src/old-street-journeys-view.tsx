...
export function OldStreetJourneysView({locale,current,api,busy,select,close}:{locale:'zh'|'en';current:string;api:(path:string)=>Promise<any>;busy:boolean;select:(id:string)=>void;close:()=>void}){
