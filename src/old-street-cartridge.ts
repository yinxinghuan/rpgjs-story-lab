...
export function oldStreetRules(locale: Locale): DomainActionRule[] {
  ...
  action('observe-darkroom', [need('darkroom-ready',true,'房间仍在准备。','The room is still being prepared.')], [], '小灯照着显影台，可以在这里查看照片。', 'The lamp lights the developing bench. You can examine the photograph here.')
