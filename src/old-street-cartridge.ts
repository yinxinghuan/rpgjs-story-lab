...
export function oldStreetRules(locale: Locale): DomainActionRule[] {
  ...
  action('observe-darkroom', [need('darkroom-ready',true,'房间仍在准备。','The room is still being prepared.')], [], '工作台上留着待整理的照片，可以在这里查看和拼合。', 'Photographs await sorting on the workbench. You can examine and match them here.')
