...
export function oldStreetRules(locale: Locale): DomainActionRule[] {
  ...
  action('observe-darkroom', [need('darkroom-ready',true,'房间仍在准备。','The room is still being prepared.')], [], '工作台上的照片还看不清，可以先在房间里看看。', 'The print is not clear yet. You can look around the room first.')
