...
const sessionPolicy={scene:(h:OldStreetHead)=>h.sceneId,assertHead:assertOldStreetHead,terminalErrors:['OLD_STREET_PHOTO_ALIGNMENT_REQUIRED','OLD_STREET_INPUT_UNSUPPORTED','OLD_STREET_ACTION_UNAVAILABLE','OLD_STREET_JOURNEY_COMPLETE','OLD_STREET_INTERPRETER_NOT_READY']}
