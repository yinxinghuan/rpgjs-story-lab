 ...
 * Fixed workshop furniture; no quest item is baked into the surface. */
...
const root='doc/oldstreet-shed-bench',bytes=readFileSync(root+'/candidate.png')
const hash=(b:Uint8Array)=>createHash('sha256').update(b).digest('hex')
if(hash(bytes)!=='5e1cef595ef4587735f14c4348d0a8e48a239d9214b604f3c4cdf979b6463ce2')throw Error('SOURCE_CHANGED')
