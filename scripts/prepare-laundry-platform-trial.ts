...
const root='doc/oldstreet-laundry-redesign/pose-preserving',raw=readFileSync(root+'/candidate.png')
const hash=(b:Uint8Array)=>createHash('sha256').update(b).digest('hex')
if(hash(raw)!=='10035a21b51874a271c776716e6e9e1aa785c748bdc327e0a9cf374717e5b7dc')throw Error('SOURCE_CHANGED')
