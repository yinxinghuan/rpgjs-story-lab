...
const room='shop',floor=oldStreetFloors[room],doors=oldStreetDoors().filter(d=>d.room===room)
...
writeFileSync('public/assets/oldstreet/watch-shop-layout-guide.svg',svg)
writeFileSync('public/assets/oldstreet/watch-shop-layout-guide.png',new Resvg(svg).render().asPng())
