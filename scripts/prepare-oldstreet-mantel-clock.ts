 ...
 * Prepare the upright clock; its underside clue is not visible from this angle. */
...
const root='doc/oldstreet-mantel-clock',bytes=readFileSync(root+'/candidate.png')
const hash=(b:Uint8Array)=>createHash('sha256').update(b).digest('hex')
if(hash(bytes)!=='a8416d18ab12fd0d516d9200cf4c57d8ec37df66fb006683e138bc18fcbc3c44')throw Error('SOURCE_CHANGED')
