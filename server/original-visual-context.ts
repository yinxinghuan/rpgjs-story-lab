...
export function originalVisualContext(h:OriginalHead,speakerId:string){
 ...
 const hero=originalBoundHero(h.assets)
 return {version:2,protagonist:{representation:'bound-walking-sheet',assetVersion:hero.id,assetSha256:hero.resource.sha256,appearance:hero.appearance,appearanceStatus:hero.appearanceStatus},backgroundVersion:originalSceneBackgroundVersion(h.assets,h.sceneId)??'legacy-scene',speaker,equipment}
}
