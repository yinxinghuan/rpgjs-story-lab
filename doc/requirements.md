...
七个室内区域（修表铺、洗衣店、照相馆、工作棚、地下室、暗房、档案间）共用上墙、侧边和前景矮墙的空间规则。上沿墙面保持64地图单位高度；前景墙以剖面表现，向地面内投影24单位，只遮住贴近墙体人物的下半部。实际门/楼梯留通口，已开放的动态入口同步开槽。街口、院子和屋顶保持室外空间，不能为统一而封成房间。仅改呈现，不更改碰撞、门落点或存档。
